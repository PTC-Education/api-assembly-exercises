...
def main():
    try:
        # Grab DID, EID, and WVMID from document URL
        docURL = "https://cad.onshape.com/documents/0af072a8e59166eb73f43a08/w/f3e2c6a9c7361be87245370d/e/39b8de68e0b8abef3cdb7967" # Change this
        WVM = "w"
        DID, EID, WVMID = get_ids(docURL, WVM)
